 ...
 */
    ...
    protected function render()
    {
        ...
        $before      = isset($s['before_text']) ? $s['before_text'] : '';
        $highlighted = isset($s['highlighted_text']) ? $s['highlighted_text'] : '';
        $after       = isset($s['after_text']) ? $s['after_text'] : '';
        $tag         = isset($s['heading_tag']) ? $s['heading_tag'] : 'h2';
        $style       = isset($s['highlight_style']) ? $s['highlight_style'] : 'none';
        ...
        if (! empty($s['heading_link']['url'])) {
            $target     = ! empty($s['heading_link']['is_external']) ? ' target="_blank"' : '';
            $nofollow   = ! empty($s['heading_link']['nofollow']) ? ' rel="nofollow"' : '';
            $link_open  = '<a href="' . esc_url($s['heading_link']['url']) . '"' . $target . $nofollow . '>';
            $link_close = '</a>';
        }
        ...
        <div class="mmm-dh-wrap">
            ...
            <<?php echo esc_attr($tag); ?> class="mmm-dh-heading">
                ...
                <?php if (! empty($highlighted)): ?>
                    <span class="<?php echo esc_attr($hl_class); ?>"<?php echo $hl_style; ?>>
